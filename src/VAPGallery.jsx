    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{
          ...
          textTransform: "uppercase", letterSpacing: 2, color: BRAND.teal,
        }}>
          Virtual Advisory Panel
        </p>
        <h1 style={{
          margin: "0 0 16px", fontSize: 32,
          fontFamily: "'Libre Baskerville', Georgia, serif",
          fontWeight: 700, color: BRAND.navy, lineHeight: 1.3,
        }}>
        ...
        <p style={{
          margin: 0, fontSize: 16, color: BRAND.midGrey, lineHeight: 1.7,
        }}>
      ...
      <div style={{
        maxWidth: 800, margin: "0 auto", padding: "20px 24px 44px",
      }}>
        <div style={{
