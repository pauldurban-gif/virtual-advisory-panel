...
`;
  ...
  const handleDownload = async (platform) => {
    ...
    try {
      const { default: JSZip } = await import("https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js").catch(() => {
        // Fallback: load via script tag
        return new Promise((resolve, reject) => {
          if (window.JSZip) { resolve({ default: window.JSZip }); return; }
          const s = document.createElement("script");
          s.src = "https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js";
          s.onload = () => resolve({ default: window.JSZip });
          s.onerror = reject;
  ...
  return (
    <div style={{
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:wght@400;700&family=DM+Sans:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap"
        rel="stylesheet"
      />
